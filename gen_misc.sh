...
export SDK_PATH="/e/ESP8266_NONOS_SDK"
export BIN_PATH="/e/bin"
export PATH=$PATH:"/e/xtensa-lx106-elf-win32-1.22.0-92-g8facf4c-5.2.0\xtensa-lx106-elf\bin"
...
make COMPILE=gcc BOOT=$boot APP=$app SPI_SPEED=$spi_speed SPI_MODE=$spi_mode SPI_FLASH_SIZE_MAP=$spi_size_map
